...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <form action="{{ route('admin.books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" class="form-control w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" id="title" value="{{ old('title', $book->title) }}" placeholder="Въведете заглавие" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="price" class="form-control w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" id="price" value="{{ old('price', $book->price) }}" placeholder="Въведете цена" required>
        </div>
