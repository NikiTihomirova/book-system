...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <!-- Снимка на книгата -->
        <div class="mb-4">
            <label for="image" class="block text-lg font-medium text-gray-700">Снимка на книгата (незадължително)</label>
            <input type="file" name="image" class="form-control w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg" id="image" accept="image/*">
        </div>
